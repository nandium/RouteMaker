<template>
  <b-jumbotron>
    ...
    <hr class="my-4" />
    <p class="lead">
      Personally, when people make routes for me at the gym, I tend to forget
      half of the moves with my goldfish memory.
    </p>
    <p class="lead">
      One way is to draw them out on handphone but it is difficult to point out the exact holds with fat fingers.
    </p>
    <p class="lead">
      Labeling the exact order of moves can be troublesome too.
    </p>
